...
public class QueryWhere<T> {
     ...
     * @return List<T> can be a list of one, many or empty, never 'null'. Can be used in a primary key select, but using {@link #selectFirst} is advised. 
     */
    ...
    /**
     * Select the first result and return it.
     * Should also be used in a primary key select.
     * 
