...
public class CommonAssembly {
	...
	public static BuildStats assenbleFiles(File outputDir, StringBuilder report) {
		...
		return new BuildStats(success, failure);
	}
	
	private static void assembleFile(File classFile) throws Exception {
